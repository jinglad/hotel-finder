  ...
  return (
    <div>
      ...
      <center>
        <div
          className="card"
          style={{ width: "30rem", marginTop: "3rem", borderColor: "gray" }}
        >
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {newUser && (
                <span className="text-danger">
                  Your password must be 6 character & also using one or more
                  number
                </span>
              )}
              <input
            ...
            <p className="text-center">
              ...
              <input
                ...
                name="newUser"
              />
              <label htmlFor="newUser" className="text-warning">
        ...
        <div className="">
          ...
          <div
            ...
            className="google d-flex justify-content-between"
          >
            <img src={google} />
